...
namespace Lingva.WebAPI.Tests
{
    ...
    public class GroupControllerTests
    {
        ...
        //    _groupController = new GroupController(_groupController, _dataAdapter, _logger, _queryOptionsAdapter);
        ...
        //    _groupService.Setup(r => r.AddAsync(groupDto)).Returns<GroupDto>(Task.FromResult(groupDto));
        //    _dataAdapter.Setup(d => d.Map<GroupDto>(groupViewModel)).Returns(groupDto);
        ...
        //    _groupService.Setup(r => r.UpdateAsync(groupDto));
        //    _dataAdapter.Setup(d => d.Map<GroupDto>(groupViewModel)).Returns(groupDto);
        //    _dataAdapter.Setup(d => d.Map<GroupViewModel>(groupDto)).Returns(groupViewModel);
        //    _groupController = new GroupController(_groupController, _dataAdapter, _logger, _queryOptionsAdapter);

        //    //act
        //    var result = await _groupController.Create(new Models.CreateOrderViewModel());
